...
Security Operations Center (SOC)
	• Organizations establish a dedicated unit called:
...
Definition
A SOC is a centralized unit that continuously:
	• Monitors 
	• Analyzes 
...
Processing Stages
	1. Collection 
		○ Gathering logs from multiple sources 
	2. Normalization 
		○ Converting logs into a standard format 
	3. Parsing 
		○ Extracting useful fields (IP, timestamp, etc.) 
	4. Indexing 
		○ Making data searchable 
	5. Correlation 
		○ Linking related events to detect patterns 
...
5. Event Correlation
	...
	• Based on: 
		○ Predefined rules 
	• Example: 
		○ Multiple failed logins + success login = possible brute force 

6. Incident Management
	• Efficient handling of incidents using: 
		○ SOC resources 
	• Key concept: 
		○ Prioritization 
			§ Based on severity 
...
Reactive Approach
	...
	• Example: 
		○ Blocking malicious IP after alert 

Proactive Approach
	• Action taken before exploitation 
	• Example: 
		○ Patching vulnerability before attack 
...
1. SOC Workflow
Definition
SOC Workflow is the step-by-step process followed in a Security Operations Center to:
	• Collect data 
	• Analyze threats 
...
3. Validate
	...
	• Ensures: 
		○ Only relevant alerts move forward 
...
2. People: SOC Analyst
Definition
A SOC Analyst (Security Analyst) is responsible for:
	• Monitoring alerts 
...
4. Security Operations Center: Processes
Definition
SOC Processes are structured procedures that ensure:
	• Efficient operations 
	• Coordination between teams and tools 
...
6. Training and Managing SOC Staff
Importance
Training ensures:
...
8. Types of SOC Models

1. In-House SOC Model
Definition
	• SOC is built and managed internally 
Advantages
...
Definition
SOC maturity models are frameworks used to measure:
	• SOC effectiveness 
	• Process maturity 
...
6. Threat Intelligence Integration
	• Effectiveness of threat intel usage 

7. Detection Coverage
	• Percentage of threats detectable 

8. Operations Audit
	• SOC process efficiency 

9. Time to Triage
	• Time to analyze alerts 

10. Time to Investigate
	• Time to fully investigate incidents 
...
--------------------
<img width="884" height="19545" alt="image" src="https://github.com/user-attachments/assets/3fb7d771-fe98-46a3-95cb-f4dd1366604a" />
